CREATE DATABASE cloud_office /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
use `cloud_office`;
#
...
VALUES (2, 0, '系统管理', 0, 'system', 'Layout', NULL, 'el-icon-s-tools', 1, 1, '2021-05-31 18:05:37',
       ...
       (30, 34, '操作日志', 1, 'sysOperaLog', 'system/sysOperaLog/list', '', 'el-icon-document-remove', 7, 1,
        '2022-05-26 16:09:59', '2022-06-09 09:39:23', 0),
       (31, 30, '查看', 2, NULL, NULL, 'bnt.sysOperaLog.list', NULL, 1, 1, '2022-05-26 16:10:17', '2022-06-09 09:22:38',
        0),
       ...
       (38, 36, '审批模板设置', 2, 'templateSet', 'processSet/processTemplate/templateSet', 'bnt.processTemplate.templateSet',
        '', 1, 1, '2022-12-01 14:52:08', '2022-12-13 18:11:56', 0),
       ...
       (48, 36, '删除', 2, '', '', 'bnt.processTemplate.remove', '', 1, 1, '2022-12-09 09:22:29', '2022-12-09 09:22:29',
        0),
       (49, 36, '发布', 2, '', '', 'bnt.processTemplate.publish', '', 1, 1, '2022-12-09 09:24:47', '2022-12-09 09:24:47',
        0),
...
#
# Structure for table "sys_opera_log"
#
...
#
# Data for table "sys_opera_log"
#

INSERT INTO `sys_opera_log`
VALUES (1, '角色管理', '1', 'org.erxi.auth.controller.SysRoleController.save()', 'POST', '1', 'admin', '',
        '/admin/auth/sysRole/save', '', '{\"param\":{},\"roleCode\":\"\",\"roleName\":\"test\",\"id\":5}',
        '{\"code\":200,\"message\":\"成功\"}', 0, '', NULL, '2022-05-26 15:59:44', NULL, 0),
       (2, '角色管理', 'DELETE', 'org.erxi.auth.controller.SysRoleController.remove()', 'DELETE', 'MANAGE', 'admin', '',
        '/admin/auth/sysRole/remove/5', '', '', '{\"code\":200,\"message\":\"成功\"}', 0, '', NULL, '2022-05-26 16:05:27',
        NULL, 0),
       (3, '角色管理', 'DELETE', 'org.erxi.auth.controller.SysRoleController.remove()', 'DELETE', 'MANAGE', 'admin', '',
        '/admin/auth/sysRole/remove/4', '127.0.0.1', '', '{\"code\":200,\"message\":\"成功\"}', 1, '', NULL,
        '2022-05-26 16:52:40', NULL, 0),
       (4, '角色管理', 'UPDATE', 'org.erxi.auth.controller.SysRoleController.updateById()', 'PUT', 'MANAGE', 'admin', '',
       ...
       (5, '菜单管理', 'UPDATE', 'org.erxi.auth.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin', '',
       ...
       (6, '岗位管理', 'UPDATE', 'org.erxi.auth.controller.SysPostController.updateById()', 'PUT', 'MANAGE', 'admin', '',
       ...
       (7, '岗位管理', 'INSERT', 'org.erxi.auth.controller.SysPostController.save()', 'POST', 'MANAGE', 'admin', '',
       ...
       (8, '岗位管理', 'DELETE', 'org.erxi.auth.controller.SysPostController.remove()', 'DELETE', 'MANAGE', 'admin', '',
        '/admin/auth/sysPost/remove/7', '127.0.0.1', '', '{\"code\":200,\"message\":\"成功\"}', 1, '', NULL,
        '2022-05-27 08:56:41', NULL, 0),
       (9, '菜单管理', 'UPDATE', 'org.erxi.auth.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin', '',
        '/admin/auth/sysMenu/update', '127.0.0.1',
       ...
       (10, '菜单管理', 'UPDATE', 'org.erxi.auth.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/auth/sysMenu/update', '127.0.0.1',
       ...
       (11, '菜单管理', 'UPDATE', 'org.erxi.auth.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/auth/sysMenu/update', '127.0.0.1',
       ...
       (12, '菜单管理', 'UPDATE', 'org.erxi.auth.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/auth/sysMenu/update', '127.0.0.1',
       ...
       (13, '部门管理', 'UPDATE', 'org.erxi.auth.controller.SysDeptController.updateById()', 'PUT', 'MANAGE', 'admin',
       ...
       (14, '部门管理', 'INSERT', 'org.erxi.auth.controller.SysDeptController.save()', 'POST', 'MANAGE', 'admin', '',
       ...
       (15, '部门管理', 'UPDATE', 'org.erxi.auth.controller.SysDeptController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/auth/sysDept/update', '127.0.0.1',
       ...
       (16, '角色管理', 'UPDATE', 'org.erxi.auth.controller.SysRoleController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/auth/sysRole/update', '127.0.0.1',
       ...
       (17, '角色管理', 'INSERT', 'org.erxi.auth.controller.SysRoleController.save()', 'POST', 'MANAGE', 'admin', '',
       ...
       (18, '角色管理', 'UPDATE', 'org.erxi.auth.controller.SysRoleController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/auth/sysRole/update', '127.0.0.1',
       ...
       (19, '菜单管理', 'UPDATE', 'org.erxi.auth.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/auth/sysMenu/update', '127.0.0.1',
       ...
       (20, '菜单管理', 'UPDATE', 'org.erxi.auth.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/auth/sysMenu/update', '127.0.0.1',
       ...
       (21, '菜单管理', 'UPDATE', 'org.erxi.auth.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/auth/sysMenu/update', '127.0.0.1',
       ...
       (22, '菜单管理', 'UPDATE', 'org.erxi.auth.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/auth/sysMenu/update', '127.0.0.1',
       ...
       (23, '菜单管理', 'UPDATE', 'org.erxi.auth.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/auth/sysMenu/update', '127.0.0.1',
       ...
       (24, '菜单管理', 'UPDATE', 'org.erxi.auth.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/auth/sysMenu/update', '127.0.0.1',
        '{\"code\":\"sysOperaLog\",\"select\":false,\"level\":3,\"toCode\":\"\",\"updateTime\":1653957062000,\"type\":1,\"parentId\":2,\"path\":\"sysOperaLog/list\",\"sortValue\":0,\"component\":\"auth/sysOperLog/list\",\"isDeleted\":0,\"children\":[{\"code\":\"bnt.sysOperLog.list\",\"select\":false,\"level\":4,\"toCode\":\"\",\"updateTime\":1653959708000,\"type\":2,\"parentId\":30,\"isDeleted\":0,\"children\":[],\"createTime\":1653552617000,\"param\":{},\"name\":\"查看\",\"perms\":\"bnt.sysOperLog.list\",\"id\":31,\"status\":1}],\"createTime\":1653552599000,\"param\":{},\"name\":\"操作日志\",\"perms\":\"bnt.sysOperLog.list\",\"id\":30,\"status\":1}',
        '{\"code\":200,\"message\":\"成功\"}', 1, '', NULL, '2022-05-31 09:19:40', NULL, 0),
       (25, '菜单管理', 'UPDATE', 'org.erxi.auth.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/auth/sysMenu/update', '127.0.0.1',
       ...
       (26, '菜单管理', 'UPDATE', 'org.erxi.auth.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/auth/sysMenu/update', '127.0.0.1',
       ...
       (27, '菜单管理', 'UPDATE', 'org.erxi.auth.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/auth/sysMenu/update', '127.0.0.1',
       ...
       (28, '菜单管理', 'UPDATE', 'org.erxi.auth.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/auth/sysMenu/update', '127.0.0.1',
       ...
       (29, '菜单管理', 'UPDATE', 'org.erxi.auth.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/auth/sysMenu/update', '127.0.0.1',
       ...
       (30, '菜单管理', 'UPDATE', 'org.erxi.auth.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/auth/sysMenu/update', '127.0.0.1',
       ...
       (31, '菜单管理', 'UPDATE', 'org.erxi.auth.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/auth/sysMenu/update', '127.0.0.1',
        '{\"code\":\"sysOperaLog\",\"select\":false,\"level\":2,\"toCode\":\"\",\"updateTime\":1653957062000,\"type\":1,\"parentId\":2,\"path\":\"sysOperaLog\",\"sortValue\":0,\"component\":\"auth/sysOperLog/list\",\"isDeleted\":0,\"children\":[{\"code\":\"bnt.sysOperLog.list\",\"select\":false,\"level\":3,\"toCode\":\"\",\"updateTime\":1653959708000,\"type\":2,\"parentId\":30,\"isDeleted\":0,\"children\":[],\"createTime\":1653552617000,\"param\":{},\"name\":\"查看\",\"perms\":\"bnt.sysOperLog.list\",\"id\":31,\"status\":1}],\"createTime\":1653552599000,\"param\":{},\"name\":\"操作日志\",\"perms\":\"bnt.sysOperLog.list\",\"id\":30,\"status\":1}',
        '{\"code\":200,\"message\":\"成功\"}', 1, '', NULL, '2022-05-31 09:42:09', NULL, 0),
       (32, '菜单管理', 'UPDATE', 'org.erxi.auth.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/auth/sysMenu/update', '127.0.0.1',
       ...
       (33, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
       ...
       (34, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
       ...
       (35, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
       ...
       (36, '岗位管理', 'INSERT', 'org.erxi.system.controller.SysPostController.save()', 'POST', 'MANAGE', 'admin', '',
       ...
       (37, '角色管理', 'INSERT', 'org.erxi.system.controller.SysRoleController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysRole/save', '127.0.0.1', '{\"param\":{},\"roleCode\":\"\",\"roleName\":\"\",\"id\":8}',
        '{\"code\":200,\"message\":\"成功\"}', 1, '', NULL, '2022-06-08 17:39:04', NULL, 0),
       (38, '角色管理', 'UPDATE', 'org.erxi.system.controller.SysRoleController.updateById()', 'PUT', 'MANAGE', 'admin',
       ...
       (39, '角色管理', 'UPDATE', 'org.erxi.system.controller.SysRoleController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysRole/update', '127.0.0.1',
        '{\"isDeleted\":0,\"createTime\":1654681144000,\"param\":{},\"roleCode\":\"\",\"roleName\":\"\",\"updateTime\":1654681144000,\"id\":8}',
        '{\"code\":200,\"message\":\"成功\"}', 1, '', NULL, '2022-06-08 17:39:41', NULL, 0),
       (40, '角色管理', 'UPDATE', 'org.erxi.system.controller.SysRoleController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysRole/update', '127.0.0.1',
       ...
       (41, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
       ...
       (42, '菜单管理', 'UPDATE', 'org.erxi.system.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
       ...
       (43, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
       ...
       (44, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
       ...
       (45, '菜单管理', 'DELETE', 'org.erxi.system.controller.SysMenuController.remove()', 'DELETE', 'MANAGE', 'admin',
        '', '/admin/system/sysMenu/remove/37', '127.0.0.1', '', '{\"code\":200,\"message\":\"成功\"}', 1, '', NULL,
        '2022-06-09 08:53:01', NULL, 0),
       (46, '菜单管理', 'DELETE', 'org.erxi.system.controller.SysMenuController.remove()', 'DELETE', 'MANAGE', 'admin',
        '', '/admin/system/sysMenu/remove/36', '127.0.0.1', '', '{\"code\":200,\"message\":\"成功\"}', 1, '', NULL,
        '2022-06-09 08:53:04', NULL, 0),
       (47, '菜单管理', 'DELETE', 'org.erxi.system.controller.SysMenuController.remove()', 'DELETE', 'MANAGE', 'admin',
        '', '/admin/system/sysMenu/remove/35', '127.0.0.1', '', '{\"code\":200,\"message\":\"成功\"}', 1, '', NULL,
        '2022-06-09 08:53:06', NULL, 0),
       (48, '菜单管理', 'UPDATE', 'org.erxi.system.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysMenu/update', '127.0.0.1',
       ...
       (49, '菜单管理', 'UPDATE', 'org.erxi.system.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysMenu/update', '127.0.0.1',
       ...
       (50, '菜单管理', 'UPDATE', 'org.erxi.system.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysMenu/update', '127.0.0.1',
       ...
       (51, '菜单管理', 'UPDATE', 'org.erxi.system.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysMenu/update', '127.0.0.1',
       ...
       (52, '菜单管理', 'UPDATE', 'org.erxi.system.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysMenu/update', '127.0.0.1',
       ...
       (53, '菜单管理', 'UPDATE', 'org.erxi.system.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysMenu/update', '127.0.0.1',
       ...
       (54, '菜单管理', 'UPDATE', 'org.erxi.system.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysMenu/update', '127.0.0.1',
        '{\"select\":false,\"icon\":\"el-icon-document-remove\",\"updateTime\":1654737785000,\"type\":1,\"parentId\":34,\"path\":\"sysOperaLog\",\"sortValue\":1,\"component\":\"system/sysOperLog/list\",\"isDeleted\":0,\"children\":[{\"select\":false,\"updateTime\":1654737758000,\"type\":2,\"parentId\":30,\"sortValue\":1,\"isDeleted\":0,\"children\":[],\"createTime\":1653552617000,\"param\":{},\"name\":\"查看\",\"perms\":\"bnt.sysOperLog.list\",\"id\":31,\"status\":1}],\"createTime\":1653552599000,\"param\":{},\"name\":\"操作日志\",\"perms\":\"\",\"id\":30,\"status\":1}',
        '{\"code\":200,\"message\":\"成功\"}', 1, '', NULL, '2022-06-09 09:24:55', NULL, 0),
       (55, '菜单管理', 'UPDATE', 'org.erxi.system.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysMenu/update', '127.0.0.1',
       ...
       (56, '用户管理', 'DELETE', 'org.erxi.system.controller.SysUserController.remove()', 'DELETE', 'MANAGE', 'admin',
        '', '/admin/system/sysUser/remove/4', '127.0.0.1', '', '{\"code\":200,\"message\":\"成功\"}', 1, '', NULL,
        '2022-06-09 09:25:21', NULL, 0),
       (57, '菜单管理', 'UPDATE', 'org.erxi.system.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysMenu/update', '127.0.0.1',
       ...
       (58, '角色管理', 'ASSGIN', 'org.erxi.system.controller.SysMenuController.doAssign()', 'POST', 'MANAGE', 'admin',
       ...
       (59, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
       ...
       (60, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
       ...
       (61, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
       ...
       (62, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
       ...
       (63, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
       ...
       (64, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
       ...
       (65, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
       ...
       (66, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
       ...
       (67, '菜单管理', 'UPDATE', 'org.erxi.system.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysMenu/update', '127.0.0.1',
       ...
       (68, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
       ...
       (69, '菜单管理', 'UPDATE', 'org.erxi.system.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysMenu/update', '127.0.0.1',
       ...
       (70, '菜单管理', 'UPDATE', 'org.erxi.system.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysMenu/update', '127.0.0.1',
       ...
       (71, '菜单管理', 'UPDATE', 'org.erxi.system.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysMenu/update', '127.0.0.1',
       ...
       (72, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
       ...
       (73, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
       ...
       (74, '菜单管理', 'UPDATE', 'org.erxi.system.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysMenu/update', '127.0.0.1',
       ...
       (75, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
       ...
       (76, '菜单管理', 'INSERT', 'org.erxisystem.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
       ...
       (77, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
       ...
       (78, '菜单管理', 'UPDATE', 'org.erxi.system.controller.SysMenuController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysMenu/update', '127.0.0.1',
       ...
       (79, '岗位管理', 'UPDATE', 'org.erxi.system.controller.SysPostController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysPost/update', '127.0.0.1',
       ...
       (80, '岗位管理', 'UPDATE', 'org.erxi.system.controller.SysPostController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysPost/update', '127.0.0.1',
       ...
       (81, '岗位管理', 'UPDATE', 'org.erxi.system.controller.SysPostController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysPost/update', '127.0.0.1',
       ...
       (82, '岗位管理', 'INSERT', 'org.erxi.system.controller.SysPostController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysPost/save', '127.0.0.1',
        '{\"param\":{},\"name\":\"编辑\",\"description\":\"\",\"postCode\":\"bj\",\"id\":9,\"status\":1}',
        '{\"code\":200,\"message\":\"成功\"}', 1, '', NULL, '2022-12-07 16:04:10', NULL, 0),
       (83, '用户管理', 'UPDATE', 'org.erxi.system.controller.SysUserController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysUser/update', '127.0.0.1',
       ...
       (84, '用户管理', 'UPDATE', 'org.erxi.system.controller.SysUserController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysUser/update', '127.0.0.1',
       ...
       (85, '用户管理', 'UPDATE', 'org.erxi.system.controller.SysUserController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysUser/update', '127.0.0.1',
       ...
       (86, '用户管理', 'UPDATE', 'org.erxi.system.controller.SysUserController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysUser/update', '127.0.0.1',
       ...
       (87, '用户管理', 'INSERT', 'org.erxi.system.controller.SysUserController.save()', 'POST', 'MANAGE', 'admin', '',
       ...
       (88, '岗位管理', 'INSERT', 'org.erxi.system.controller.SysPostController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysPost/save', '127.0.0.1',
        '{\"param\":{},\"name\":\"讲师\",\"description\":\"\",\"postCode\":\"js\",\"id\":10,\"status\":1}',
        '{\"code\":200,\"message\":\"成功\"}', 1, '', NULL, '2022-12-07 16:47:34', NULL, 0),
       (89, '用户管理', 'UPDATE', 'org.erxi.system.controller.SysUserController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysUser/update', '127.0.0.1',
       ...
       (90, '部门管理', 'INSERT', 'org.erxi.system.controller.SysDeptController.save()', 'POST', 'MANAGE', 'admin', '',
       ...
       (91, '用户管理', 'UPDATE', 'org.erxi.system.controller.SysUserController.updateById()', 'PUT', 'MANAGE', 'admin',
        '', '/admin/system/sysUser/update', '127.0.0.1',
       ...
       (92, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
       ...
       (93, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
       ...
       (94, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
       ...
       (95, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
       ...
       (96, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
       ...
       (97, '菜单管理', 'INSERT', 'org.erxi.system.controller.SysMenuController.save()', 'POST', 'MANAGE', 'admin', '',
        '/admin/system/sysMenu/save', '127.0.0.1',
